	...
	if ( ! class_exists( 'Dianxiaomi' ) ) {
		...
		final class Dianxiaomi {
			...
			public function admin_styles(): void {
				$version = '1.0.20'; // Version of your plugin
				wp_enqueue_style( 'dianxiaomi_styles_chosen', plugins_url( basename( dirname( __DIR__ ) ) ) . '/assets/plugin/chosen/chosen.min.css', array(), $version );
				wp_enqueue_style( 'dianxiaomi_styles', plugins_url( basename( dirname( __DIR__ ) ) ) . '/assets/css/admin.css', array(), $version );
			}
			...
			public function library_scripts(): void {
				$version = '1.0.20'; // Version of your plugin
				wp_enqueue_script( 'dianxiaomi_script_chosen_jquery', plugins_url( basename( dirname( __DIR__ ) ) ) . '/assets/plugin/chosen/chosen.jquery.min.js', array(), $version, true );
				wp_enqueue_script( 'dianxiaomi_script_chosen_proto', plugins_url( basename( dirname( __DIR__ ) ) ) . '/assets/plugin/chosen/chosen.proto.min.js', array(), $version, true );
				wp_enqueue_script( 'dianxiaomi_script_util', plugins_url( basename( dirname( __DIR__ ) ) ) . '/assets/js/util.js', array(), $version, true );
				wp_enqueue_script( 'dianxiaomi_script_couriers', plugins_url( basename( dirname( __DIR__ ) ) ) . '/assets/js/couriers.js', array(), $version, true );
				wp_enqueue_script( 'dianxiaomi_script_admin', plugins_url( basename( dirname( __DIR__ ) ) ) . '/assets/js/admin.js', array(), $version, true );
			}
			...
			public function include_footer_script(): void {
				$version = '1.0.20'; // Version of your plugin
				wp_enqueue_script( 'dianxiaomi_script_footer', plugins_url( basename( dirname( __DIR__ ) ) ) . '/assets/js/footer.js', array(), $version, true );
			}
				...
				foreach ( $this->dianxiaomi_fields as $field ) {
					if ( $field['type'] === 'date' ) {
						woocommerce_wp_text_input(
							array(
								'id'          => $field['id'],
								'label'       => ( $field['label'], 'wc_dianxiaomi' ),
