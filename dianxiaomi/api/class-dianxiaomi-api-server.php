...
class Dianxiaomi_API_Server
{
    ...
    {
        $this->path = $path ?: ($_SERVER['PATH_INFO'] ?? '/');
    ...
    public function check_authentication(): WP_User|WP_Error
    {
        ...
        if (is_a($user, 'WP_User')) {
            ...
            $user = new WP_Error('dianxiaomi_api_authentication_error', __('Invalid authentication method', 'dianxiaomi'), ['code' => 500]);
        }
        return $user;
    }
    ...
    public function serve_request(): void
    {
        ...
        if (!apply_filters('dianxiaomi_api_enabled', true, $this) || ('no' === get_option('dianxiaomi_api_enabled'))) {
            ...
            echo $this->handler->generate_response(['errors' => ['code' => 'dianxiaomi_api_disabled', 'message' => 'The WooCommerce API is disabled on this site']]);
            return;
        }
